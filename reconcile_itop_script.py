...
def determine_organization(fqdn: str) -> str:
    """Optional heuristic to choose Organization by FQDN. Adjust to your tenant."""
    ...
    try:
        with open(csv_path, 'r', newline='', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                # Choose class by a simple heuristic (adjust as needed)
                org = determine_organization(fqdn)
                machine_class = 'Server' if org in ('CHNO', 'ADU') else 'VirtualMachine'
